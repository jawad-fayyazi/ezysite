...
$ACCESS_PWD='eZy$ite786110'; #!!!IMPORTANT!!! this is script access password, SET IT if you want to protect you DB from public access
...
$DBDEF=array(
'user'=>"ezysite_root",#required
'pwd'=>'', #required
#optional:
'db'=>"ezysite_db",  #default DB
'host'=>"localhost",
'port'=>"3306",
'socket'=>"",
