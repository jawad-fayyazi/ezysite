<div x-data="{ sidebarOpen: false }"  @open-sidebar.window="sidebarOpen = true"
    ...
    <div :class="{ '-translate-x-full': !sidebarOpen }"
        class="fixed top-0 left-0 flex items-stretch -translate-x-full overflow-hidden lg:translate-x-0 z-50 h-dvh md:h-screen transition-[width,transform] duration-150 ease-out bg-white dark:bg-gray-800 w-64 group @if(config('wave.dev_bar')){{ 'pb-10' }}@endif">  
        <div class="flex flex-col justify-between w-full overflow-auto md:h-full h-svh pt-4 pb-2.5">
            <div class="relative flex flex-col">
                ...
                <div class="flex flex-col justify-start items-center px-4 space-y-1.5 w-full h-full text-slate-600 dark:text-zinc-400">
                    ...
                    <x-app.sidebar-link href="/websites" icon="phosphor-globe" :active="(Request::is('websites'))">Websites</x-app.sidebar-link>
